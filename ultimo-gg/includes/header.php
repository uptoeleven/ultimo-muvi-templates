            ...
            <div class="row h-100">
                <div class="col-xs-12 col-sm-7 h-100">
                    <div class="h-100 d-flex flex-between">
                        ...
                        <div class="search-bar flex-grow-1 ml-2 mr-3">
                            <div class="form-group position-relative mb-0">
                                <input type="email" class="form-control" id="menusearchbar" placeholder="Search">
                                    <div class="position-absolute search-icon d-flex flex-center">
                                    <img src="images/icons/search.svg">
                                </div>
                            </div>
                        </div>
                        <div id="nav_button" class="rounded-circle d-md-none">
                            <a id="hidden-nav-button" class="d-flex flex-center border-0">
                                <span></span>
                            </a>
                        </div>
                        <a href="#" class="alarm d-none d-md-flex flex-center"></a>
                    </div>
                </div>
